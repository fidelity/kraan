...
func (f FakeApplier) ApplyIsRequired(ctx context.Context, layer layers.Layer) (bool, error) {
	return false, nil
}
...
func (f FakeApplier) Adopt(ctx context.Context, layer layers.Layer, hr *helmctlv2.HelmRelease) error {
	return nil
}
